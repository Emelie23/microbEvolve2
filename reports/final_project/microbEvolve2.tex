...
\subsection*{Inter-Infant and Inter-Timepoint Differences}
For the k-mer-based analysis, no significant differences in Shannon diversity are observed between 2, 4, and 6 months, indicating that alpha diversity remains stable across infants during the first 6 months of life. Interestingly, when looking at the alpha diversity calculated from ASV-based core metrics, there is a significant difference between 2 and 4 months ($q=0.089$) and between 2 and 6 months ($q=0.089$).
...
From 2 to 6 months, pathways associated with human milk oligosaccharide (HMO) breakdown, such as fucose and acetlyneuraminate degradation, decreased in abundance \cite{yu_comprehensive_2025,duman_human_2024}.
