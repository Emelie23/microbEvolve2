...
This indicates that alpha diversity remains stable across infants during the first six months of life. Interestingly, when looking at the alpha diversity calculated from ASV-based core metrics, there is a significant correlation between Shannon entropy and age ($p = 0.022$).
